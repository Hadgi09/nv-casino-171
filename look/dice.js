...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-855243fa');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-855243fa');}
...
var brandEl=document.querySelector('.rl-brand-855243fa');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
